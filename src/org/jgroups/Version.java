 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.59.2.16.2.2 2009/05/06 10:58:22 belaban Exp $
...
public class Version {
    ...
    public static final String description="2.6.10.merge";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.59.2.16.2.2 2009/05/06 10:58:22 belaban Exp $";
